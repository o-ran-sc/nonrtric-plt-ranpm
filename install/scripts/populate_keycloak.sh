...
# Scripted intended to be sourced by other script to add functions to the keycloak rest API
...
get_client_token() {
	...
	__TMP_TOKEN=$(curl -v -f -X POST $KC_URL/realms/$__realm/protocol/openid-connect/token   \
