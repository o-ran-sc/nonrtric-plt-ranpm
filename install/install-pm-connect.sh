...
envsubst '${PM_KAFKA_CONNECT_BEAN}' < nrt-pm-kafka-connect/values-template.yaml > nrt-pm-kafka-connect/values.yaml
...
echo " helm install..."
helm install -n nonrtric nrt-pm-kafka-connect nrt-pm-kafka-connect
