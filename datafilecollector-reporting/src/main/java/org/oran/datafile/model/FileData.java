...
public class FileData {
    ...
    public FileReadyMessage.FileInfo fileInfo;
    ...
    public static Iterable<FileData> createFileData(FileReadyMessage msg) {
        ...
        for (FileReadyMessage.FileInfo arr : msg.event.stndDefinedFields.data.fileInfoList) {
    ...
    public String name() {
        return this.messageMetaData.sourceName + "/" + fileInfo.fileName();
    }
    ...
    public String remoteFilePath() {
        return URI.create(fileInfo.fileLocation).getPath();
    }

    public Scheme scheme() {
        URI uri = URI.create(fileInfo.fileLocation);
        try {
    ...
    public Path getLocalFilePath(AppConfig config) {
        return Paths.get(config.getCollectedFilesPath(), this.messageMetaData.sourceName, fileInfo.fileName());
    }
