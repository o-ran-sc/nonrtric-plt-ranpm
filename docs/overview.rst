...
The OSC Non-RT RIC provides a high performing, fully scalable end-to-end solution for handling of
...
The files collected from the RAN and stored. An rApp can subscribe for chosen measurement types from
